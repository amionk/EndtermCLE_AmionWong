...
public class MauriceNecklace extends AppCompatActivity implements OnClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_maurice_necklace);
            ...
            //for price list//
            labor = 1510; // Labor for Maurice Necklace
            overhead = 0.10; // 10%
        ...
        public void onClick(View v) {
            ...
            switch (id) {
                case R.id.btnReferences:
                    ...
                    Intent i = new Intent(MauriceNecklace.this, Materials.class);
                    startActivity(i);
                    break;

                case R.id.btnCalculate:
                    Toast.makeText(this, "Computing prices....", Toast.LENGTH_SHORT).show();
                    inputMetal = (EditText) findViewById(R.id.inputMetal_n2);
                    inputGems = (EditText) findViewById(R.id.inputGems_n2);
                    ...
                    switch (Custom) {
                        case 1:
                            ...
                            Intent pricelist1 = new Intent(MauriceNecklace.this, PriceList.class);
                        ...
                        case 2:
                            ...
                            Intent pricelist2 = new Intent(MauriceNecklace.this, PriceList.class);
                        ...
                        case 3:
                            ...
                            Intent pricelist3 = new Intent(MauriceNecklace.this, PriceList.class);
                        ...
                        case 4:
                            ...
                            Intent pricelist4 = new Intent(MauriceNecklace.this, PriceList.class);
