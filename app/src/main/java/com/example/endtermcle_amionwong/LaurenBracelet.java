...
public class LaurenBracelet extends AppCompatActivity implements OnClickListener{
    ...
    Button btnCompute, btnRef;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_lauren_bracelet);
            ...
            //for price list//
            labor = 1200.82; // labor for Lauren Cross Bracelet
            overhead = 0.10; //10%
        ...
        public void onClick(View v) {
            ...
            switch (id) {
                case R.id.btnReferences:
                    ...
                    Intent i = new Intent(LaurenBracelet.this, Materials.class);
                    startActivity(i);
                    break;

                case R.id.btnCalculate:
                    Toast.makeText(this, "Computing prices....", Toast.LENGTH_SHORT).show();
                    inputMetal = (EditText) findViewById(R.id.inputMetal_b1);
                    inputGems = (EditText) findViewById(R.id.inputGems_b1);
                    ...
                    switch (Custom) {
                        case 1:
                            ...
                            Intent pricelist1 = new Intent(LaurenBracelet.this, PriceList.class);
                        ...
                        case 2:
                            ...
                            Intent pricelist2 = new Intent(LaurenBracelet.this, PriceList.class);
                        ...
                        case 3:
                            ...
                            Intent pricelist3 = new Intent(LaurenBracelet.this, PriceList.class);
                        ...
                        case 4:
                            ...
                            Intent pricelist4 = new Intent(LaurenBracelet.this, PriceList.class);
