...
public class JaquiBracelet extends AppCompatActivity implements OnClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_jaqui_bracelet);
            ...
            //for price list//
            labor = 1160.55; // labor for Jaqui Alter Bracelet
            overhead = 0.10; //10%
        ...
        public void onClick(View v) {
            ...
            switch (id) {
                case R.id.btnReferences:
                    ...
                    Intent i = new Intent(JaquiBracelet.this, Materials.class);
                    startActivity(i);
                    break;

                case R.id.btnCalculate:
                    Toast.makeText(this, "Computing prices....", Toast.LENGTH_SHORT).show();
                    inputMetal = (EditText) findViewById(R.id.inputMetal_b2);
                    inputGems = (EditText) findViewById(R.id.inputGems_b2);
                    ...
                    switch (Custom) {
                        case 1:
                            ...
                            Intent pricelist1 = new Intent(JaquiBracelet.this, PriceList.class);
                        ...
                        case 2:
                            ...
                            Intent pricelist2 = new Intent(JaquiBracelet.this, PriceList.class);
                        ...
                        case 3:
                            ...
                            Intent pricelist3 = new Intent(JaquiBracelet.this, PriceList.class);
                        ...
                        case 4:
                            ...
                            Intent pricelist4 = new Intent(JaquiBracelet.this, PriceList.class);
