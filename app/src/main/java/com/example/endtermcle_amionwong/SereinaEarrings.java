...
public class SereinaEarrings extends AppCompatActivity implements OnClickListener{
    ...
    Button btnCompute, btnRef;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_sereina_earrings);
            ...
            //for price list//
            labor = 1245; // labor for Sereina Dangle Earrings
            overhead = 0.10; //10%
        ...
        public void onClick(View v) {
            ...
            switch (id) {
                case R.id.btnReferences:
                    ...
                    Intent i = new Intent(SereinaEarrings.this, Materials.class);
                    startActivity(i);
                    break;

                case R.id.btnCalculate:
                    Toast.makeText(this, "Computing prices....", Toast.LENGTH_SHORT).show();
                    inputMetal = (EditText) findViewById(R.id.inputMetal_e2);
                    inputGems = (EditText) findViewById(R.id.inputGems_e2);
                    ...
                    switch (Custom) {
                        case 1:
                            ...
                            Intent pricelist1 = new Intent(SereinaEarrings.this, PriceList.class);
                        ...
                        case 2:
                            ...
                            Intent pricelist2 = new Intent(SereinaEarrings.this, PriceList.class);
                        ...
                        case 3:
                            ...
                            Intent pricelist3 = new Intent(SereinaEarrings.this, PriceList.class);
                        ...
                        case 4:
                            ...
                            Intent pricelist4 = new Intent(SereinaEarrings.this, PriceList.class);
